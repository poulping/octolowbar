<article data-time="<?php echo $content->getDateTimeObject('date_published')->format('U');?>" data-remote="<?php echo url_for('@show_content?id='.$content->getId())?>"<?php echo ($col) ? ' data-col="'.$col.'"' : '';?> class="m-item l-<?php echo $content->getType()?> animated">
    <header>
